...
namespace Com.OneSignal.iOS {
	[Register("OneSignalNative", true)]
	public unsafe partial class OneSignalNative : NSObject {
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		static readonly IntPtr class_ptr = Class.GetHandle ("OneSignalNative");
		public override IntPtr ClassHandle { get { return class_ptr; } }
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		[Export ("init")]
		public OneSignalNative () : base (NSObjectFlag.Empty)
		{
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected OneSignalNative (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		protected internal OneSignalNative (IntPtr handle) : base (handle)
		{
			IsDirectBinding = GetType ().Assembly == global::ApiDefinition.Messaging.this_assembly;
		}
		...
		public static void AddEmailSubscriptionObserver (OSEmailSubscriptionObserver observer)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("addEmailSubscriptionObserver:"), observer__handle__);
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("addPermissionObserver:"), observer__handle__);
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("addSMSSubscriptionObserver:"), observer__handle__);
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("addSubscriptionObserver:"), observer__handle__);
		}
		...
		public static void AddTrigger (string key, NSObject value)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("addTrigger:withValue:"), nskey, value__handle__);
		...
		public static void AddTriggers (NSDictionary triggers)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("addTriggers:"), triggers__handle__);
		}
		...
		{
			return  Runtime.GetNSObject<OSDeviceState> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("getDeviceState")))!;
		}
		...
		public static global::UserNotifications.UNMutableNotificationContent DidReceiveNotificationExtensionRequest (global::UserNotifications.UNNotificationRequest request, global::UserNotifications.UNMutableNotificationContent? replacementContent)
		{
			...
			return  Runtime.GetNSObject<global::UserNotifications.UNMutableNotificationContent> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("didReceiveNotificationExtensionRequest:withMutableNotificationContent:"), request__handle__, replacementContent__handle__))!;
		}
		[Export ("didReceiveNotificationExtensionRequest:withMutableNotificationContent:withContentHandler:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public unsafe static global::UserNotifications.UNMutableNotificationContent DidReceiveNotificationExtensionRequest (global::UserNotifications.UNNotificationRequest request, global::UserNotifications.UNMutableNotificationContent? replacementContent, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDActionArity1V0))]global::System.Action<global::UserNotifications.UNNotificationContent> contentHandler)
		{
			var request__handle__ = request.GetNonNullHandle (nameof (request));
			var replacementContent__handle__ = replacementContent.GetHandle ();
			...
			block_contentHandler.SetupBlockUnsafe (Trampolines.SDActionArity1V0.Handler, contentHandler);
			global::UserNotifications.UNMutableNotificationContent? ret;
			ret =  Runtime.GetNSObject<global::UserNotifications.UNMutableNotificationContent> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("didReceiveNotificationExtensionRequest:withMutableNotificationContent:withContentHandler:"), request__handle__, replacementContent__handle__, (IntPtr) block_ptr_contentHandler))!;
		...
		public static NSObject? GetTriggerValueForKey (string key)
		{
			...
			var nskey = CFString.CreateNative (key);
			NSObject? ret;
			ret = Runtime.GetNSObject (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("getTriggerValueForKey:"), nskey))!;
			CFString.ReleaseNative (nskey);
			return ret!;
		}
		[Export ("getTriggers")]
		...
		{
			return  Runtime.GetNSObject<NSDictionary<NSString, NSObject>> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("getTriggers")))!;
		}
		...
		public static void InitWithLaunchOptions (NSDictionary? launchOptions)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("initWithLaunchOptions:"), launchOptions__handle__);
		}
		...
		public unsafe static void LogoutEmailWithSuccess ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailSuccessBlock))]OSEmailSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailFailureBlock))]OSEmailFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("logoutEmailWithSuccess:withFailure:"), (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
				block_ptr_failureBlock->CleanupBlock ();
		...
		public unsafe static void LogoutSMSNumberWithSuccess ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSSuccessBlock))]OSSMSSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSFailureBlock))]OSSMSFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("logoutSMSNumberWithSuccess:withFailure:"), (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
				block_ptr_failureBlock->CleanupBlock ();
		...
		public static void OnesignalLog (OneSLogLevel logLevel, string message)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_UIntPtr_IntPtr (class_ptr, Selector.GetHandle ("onesignalLog:message:"), (UIntPtr) (ulong) logLevel, nsmessage);
		...
		public static void PostNotification (NSDictionary jsonData)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("postNotification:"), jsonData__handle__);
		}
		...
		public unsafe static void PostNotification (NSDictionary jsonData, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSResultSuccessBlock))]OSResultSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSFailureBlock))]OSFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("postNotification:onSuccess:onFailure:"), jsonData__handle__, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
				block_ptr_failureBlock->CleanupBlock ();
		...
		public unsafe static void PromptForPushNotificationsWithUserResponse ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUserResponseBlock))]OSUserResponseBlock block)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("promptForPushNotificationsWithUserResponse:"), (IntPtr) block_ptr_block);
		...
		public unsafe static void PromptForPushNotificationsWithUserResponse ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUserResponseBlock))]OSUserResponseBlock block, bool fallback)
		{
			...
			block_ptr_block = &block_block;
			block_block.SetupBlockUnsafe (Trampolines.SDOSUserResponseBlock.Handler, block);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_bool (class_ptr, Selector.GetHandle ("promptForPushNotificationsWithUserResponse:fallbackToSettings:"), (IntPtr) block_ptr_block, fallback);
			block_ptr_block->CleanupBlock ();
		}
		...
		public unsafe static void RegisterForProvisionalAuthorization ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUserResponseBlock))]OSUserResponseBlock block)
		{
			...
			block_ptr_block = &block_block;
			block_block.SetupBlockUnsafe (Trampolines.SDOSUserResponseBlock.Handler, block);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("registerForProvisionalAuthorization:"), (IntPtr) block_ptr_block);
			block_ptr_block->CleanupBlock ();
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removeEmailSubscriptionObserver:"), observer__handle__);
		}
		...
		public unsafe static void RemoveExternalUserId ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdSuccessBlock))]OSUpdateExternalUserIdSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdFailureBlock))]OSUpdateExternalUserIdFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("removeExternalUserId:withFailure:"), (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
				block_ptr_failureBlock->CleanupBlock ();
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removePermissionObserver:"), observer__handle__);
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removeSMSSubscriptionObserver:"), observer__handle__);
		}
		...
		{
			var observer__handle__ = observer.GetNonNullHandle (nameof (observer));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removeSubscriptionObserver:"), observer__handle__);
		}
		...
		public static void RemoveTriggerForKey (string key)
		{
			if (key is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (key));
			var nskey = CFString.CreateNative (key);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removeTriggerForKey:"), nskey);
			CFString.ReleaseNative (nskey);
		}
		...
		public static void RemoveTriggersForKeys (string[] keys)
		{
			if (keys is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (keys));
			var nsa_keys = NSArray.FromStrings (keys);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("removeTriggersForKeys:"), nsa_keys.Handle);
			nsa_keys.Dispose ();
		}
		...
		public static void SendOutcome (string name)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("sendOutcome:"), nsname);
		...
		public unsafe static void SendOutcome (string name, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSendOutcomeSuccess))]OSSendOutcomeSuccess? success)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("sendOutcome:onSuccess:"), nsname, (IntPtr) block_ptr_success);
			CFString.ReleaseNative (nsname);
		...
		public static void SendOutcomeWithValue (string name, NSNumber value)
		{
			...
			var value__handle__ = value.GetNonNullHandle (nameof (value));
			var nsname = CFString.CreateNative (name);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("sendOutcomeWithValue:value:"), nsname, value__handle__);
			CFString.ReleaseNative (nsname);
		}
		...
		public unsafe static void SendOutcomeWithValue (string name, NSNumber value, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSendOutcomeSuccess))]OSSendOutcomeSuccess? success)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("sendOutcomeWithValue:value:onSuccess:"), nsname, value__handle__, (IntPtr) block_ptr_success);
			CFString.ReleaseNative (nsname);
			if (block_ptr_success != null)
				block_ptr_success->CleanupBlock ();
		}
		...
		public unsafe static void SendTags (NSDictionary keyValuePair, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSResultSuccessBlock))]OSResultSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSFailureBlock))]OSFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("sendTags:onSuccess:onFailure:"), keyValuePair__handle__, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
				block_ptr_failureBlock->CleanupBlock ();
		...
		{
			var keyValuePair__handle__ = keyValuePair.GetNonNullHandle (nameof (keyValuePair));
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("sendTags:"), keyValuePair__handle__);
		}
		...
		public static void SendUniqueOutcome (string name)
		{
			if (name is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (name));
			var nsname = CFString.CreateNative (name);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("sendUniqueOutcome:"), nsname);
			CFString.ReleaseNative (nsname);
		}
		...
		public unsafe static void SendUniqueOutcome (string name, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSendOutcomeSuccess))]OSSendOutcomeSuccess? success)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("sendUniqueOutcome:onSuccess:"), nsname, (IntPtr) block_ptr_success);
			CFString.ReleaseNative (nsname);
			if (block_ptr_success != null)
				block_ptr_success->CleanupBlock ();
		}
		...
		public static global::UserNotifications.UNMutableNotificationContent ServiceExtensionTimeWillExpireRequest (global::UserNotifications.UNNotificationRequest request, global::UserNotifications.UNMutableNotificationContent? replacementContent)
		{
			var request__handle__ = request.GetNonNullHandle (nameof (request));
			var replacementContent__handle__ = replacementContent.GetHandle ();
			return  Runtime.GetNSObject<global::UserNotifications.UNMutableNotificationContent> (global::ApiDefinition.Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("serviceExtensionTimeWillExpireRequest:withMutableNotificationContent:"), request__handle__, replacementContent__handle__))!;
		}
		...
		public static void SetEmail (string email, string? hashToken)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setEmail:withEmailAuthHashToken:"), nsemail, nshashToken);
		...
		public unsafe static void SetEmail (string email, string? hashToken, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailSuccessBlock))]OSEmailSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailFailureBlock))]OSEmailFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setEmail:withEmailAuthHashToken:withSuccess:withFailure:"), nsemail, nshashToken, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nsemail);
			CFString.ReleaseNative (nshashToken);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
		...
		public static void SetEmail (string email)
		{
			if (email is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (email));
			var nsemail = CFString.CreateNative (email);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setEmail:"), nsemail);
			CFString.ReleaseNative (nsemail);
		}
		...
		public unsafe static void SetEmail (string email, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailSuccessBlock))]OSEmailSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSEmailFailureBlock))]OSEmailFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setEmail:withSuccess:withFailure:"), nsemail, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nsemail);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
		...
		public static void SetExternalUserId (string externalId)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setExternalUserId:"), nsexternalId);
		...
		public unsafe static void SetExternalUserId (string externalId, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdSuccessBlock))]OSUpdateExternalUserIdSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdFailureBlock))]OSUpdateExternalUserIdFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setExternalUserId:withSuccess:withFailure:"), nsexternalId, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nsexternalId);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
		...
		public unsafe static void SetExternalUserId (string externalId, string hashToken, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdSuccessBlock))]OSUpdateExternalUserIdSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateExternalUserIdFailureBlock))]OSUpdateExternalUserIdFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setExternalUserId:withExternalIdAuthHashToken:withSuccess:withFailure:"), nsexternalId, nshashToken, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nsexternalId);
			CFString.ReleaseNative (nshashToken);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
		...
		public unsafe static void SetInAppMessageClickHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSInAppMessageClickBlock))]OSInAppMessageClickBlock? block)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setInAppMessageClickHandler:"), (IntPtr) block_ptr_block);
		...
		public static void SetInAppMessageLifecycleHandler (OSInAppMessageLifecycleHandler? @delegate)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setInAppMessageLifecycleHandler:"), @delegate__handle__);
		}
		[Export ("setLanguage:")]
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static void SetLanguage (string language)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setLanguage:"), nslanguage);
		...
		public unsafe static void SetLanguage (string language, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateLanguageSuccessBlock))]OSUpdateLanguageSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSUpdateLanguageFailureBlock))]OSUpdateLanguageFailureBlock failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setLanguage:withSuccess:withFailure:"), nslanguage, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nslanguage);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			block_ptr_failureBlock->CleanupBlock ();
		...
		public static void SetMSDKType (string type)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setMSDKType:"), nstype);
		...
		public unsafe static void SetNotificationOpenedHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSNotificationOpenedBlock))]OSNotificationOpenedBlock? block)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setNotificationOpenedHandler:"), (IntPtr) block_ptr_block);
			if (block_ptr_block != null)
				block_ptr_block->CleanupBlock ();
		}
		...
		public unsafe static void SetNotificationWillShowInForegroundHandler ([BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSNotificationWillShowInForegroundBlock))]OSNotificationWillShowInForegroundBlock? block)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setNotificationWillShowInForegroundHandler:"), (IntPtr) block_ptr_block);
			if (block_ptr_block != null)
				block_ptr_block->CleanupBlock ();
		}
		...
		public static void SetSMSNumber (string smsNumber, string? hashToken)
		{
			...
			var nshashToken = CFString.CreateNative (hashToken);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setSMSNumber:withSMSAuthHashToken:"), nssmsNumber, nshashToken);
		...
		public unsafe static void SetSMSNumber (string smsNumber, string? hashToken, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSSuccessBlock))]OSSMSSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSFailureBlock))]OSSMSFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setSMSNumber:withSMSAuthHashToken:withSuccess:withFailure:"), nssmsNumber, nshashToken, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nssmsNumber);
			CFString.ReleaseNative (nshashToken);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
		...
		public static void SetSMSNumber (string smsNumber)
		{
			if (smsNumber is null)
				ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (smsNumber));
			var nssmsNumber = CFString.CreateNative (smsNumber);
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setSMSNumber:"), nssmsNumber);
			CFString.ReleaseNative (nssmsNumber);
		}
		...
		public unsafe static void SetSMSNumber (string smsNumber, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSSuccessBlock))]OSSMSSuccessBlock? successBlock, [BlockProxy (typeof (ObjCRuntime.Trampolines.NIDOSSMSFailureBlock))]OSSMSFailureBlock? failureBlock)
		{
			...
			global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr (class_ptr, Selector.GetHandle ("setSMSNumber:withSuccess:withFailure:"), nssmsNumber, (IntPtr) block_ptr_successBlock, (IntPtr) block_ptr_failureBlock);
			CFString.ReleaseNative (nssmsNumber);
			if (block_ptr_successBlock != null)
				block_ptr_successBlock->CleanupBlock ();
			if (block_ptr_failureBlock != null)
		...
		public static string AppId {
			[Export ("appId")]
			get {
				return CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("appId")))!;
			}
			[Export ("setAppId:")]
			set {
				if (value is null)
					ObjCRuntime.ThrowHelper.ThrowArgumentNullException (nameof (value));
				var nsvalue = CFString.CreateNative (value);
				global::ApiDefinition.Messaging.void_objc_msgSend_IntPtr (class_ptr, Selector.GetHandle ("setAppId:"), nsvalue);
				CFString.ReleaseNative (nsvalue);
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static string SdkSemanticVersion {
			...
			get {
				return CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("sdkSemanticVersion")))!;
			}
		}
		[BindingImpl (BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
		public static string SdkVersionRaw {
			...
			get {
				return CFString.FromHandle (global::ApiDefinition.Messaging.IntPtr_objc_msgSend (class_ptr, Selector.GetHandle ("sdkVersionRaw")))!;
			}
		}
	} /* class OneSignalNative */
}
