...
@class ApiDefinition__Com_OneSignal_iOS_OSInAppMessageDelegate;
...
@interface OSDeviceState : NSObject {
	...
	-(BOOL) isSubscribed;
	-(NSInteger) notificationPermissionStatus;
	-(NSString *) pushToken;
	-(NSString *) smsNumber;
	-(NSString *) smsUserId;
	-(NSString *) userId;
...
@protocol OSEmailSubscriptionObserver
	@required -(void) onOSEmailSubscriptionChanged:(id)p0;
@end
...
@interface ApiDefinition__Com_OneSignal_iOS_OSInAppMessageDelegate : NSObject<OSInAppMessageDelegate> {
}
	-(id) init;
@end

@protocol OSInAppMessageLifecycleHandler
	@optional -(void) onWillDisplayInAppMessage:(id)p0;
	@optional -(void) onDidDisplayInAppMessage:(id)p0;
	@optional -(void) onWillDismissInAppMessage:(id)p0;
	@optional -(void) onDidDismissInAppMessage:(id)p0;
@end
...
@interface OSInAppMessageOutcome : NSObject {
	...
	-(BOOL) unique;
	-(void) setUnique:(BOOL)p0;
	-(NSNumber *) weight;
	-(void) setWeight:(NSNumber *)p0;
	-(id) init;
@end
...
@interface OSInAppMessageTag : NSObject {
	...
	-(NSDictionary *) jsonRepresentation;
	-(NSDictionary *) tagsToAdd;
	-(void) setTagsToAdd:(NSDictionary *)p0;
	-(NSArray *) tagsToRemove;
	-(void) setTagsToRemove:(NSArray *)p0;
	-(id) init;
@end
...
@interface OSOutcomeEvent : NSObject {
	...
	-(void) setNotificationIds:(NSArray *)p0;
	-(NSUInteger) session;
	-(void) setSession:(NSUInteger)p0;
	-(NSNumber *) timestamp;
	-(void) setTimestamp:(NSNumber *)p0;
	-(NSDecimalNumber *) weight;
	-(void) setWeight:(NSDecimalNumber *)p0;
	-(id) init;
@end

@protocol OSPermissionObserver
	@required -(void) onOSPermissionChanged:(id)p0;
@end
...
@protocol OSSMSSubscriptionObserver
	@required -(void) onOSSMSSubscriptionChanged:(id)p0;
@end
...
@protocol OSSubscriptionObserver
	@required -(void) onOSSubscriptionChanged:(id)p0;
@end
