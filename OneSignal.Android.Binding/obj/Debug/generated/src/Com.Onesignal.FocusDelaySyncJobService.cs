...
namespace Com.Onesignal {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.onesignal']/class[@name='FocusDelaySyncJobService']"
	[global::Android.Runtime.Register ("com/onesignal/FocusDelaySyncJobService", DoNotGenerateAcw=true)]
	public partial class FocusDelaySyncJobService : global::Android.App.Job.JobService {
		static readonly JniPeerMembers _members = new XAPeerMembers ("com/onesignal/FocusDelaySyncJobService", typeof (FocusDelaySyncJobService));
		...
		protected FocusDelaySyncJobService (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer)
		{
		}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.onesignal']/class[@name='FocusDelaySyncJobService']/constructor[@name='FocusDelaySyncJobService' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FocusDelaySyncJobService () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.FocusDelaySyncJobService> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/class[@name='FocusDelaySyncJobService']/method[@name='onStartJob' and count(parameter)=1 and parameter[1][@type='android.app.job.JobParameters']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/class[@name='FocusDelaySyncJobService']/method[@name='onStopJob' and count(parameter)=1 and parameter[1][@type='android.app.job.JobParameters']]"
