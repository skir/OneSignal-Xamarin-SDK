...
namespace Com.Onesignal {
	...
	[Register ("com/onesignal/OSTime", "", "Com.Onesignal.IOSTimeInvoker")]
	public partial interface IOSTime : IJavaObject, IJavaPeerable {
		long CurrentThreadTimeMillis {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.onesignal']/interface[@name='OSTime']/method[@name='getCurrentThreadTimeMillis' and count(parameter)=0]"
			[Register ("getCurrentThreadTimeMillis", "()J", "GetGetCurrentThreadTimeMillisHandler:Com.Onesignal.IOSTimeInvoker, OneSignal.Android.Binding")]
			get; 
		}
		...
		long CurrentTimeMillis {
			...
			[Register ("getCurrentTimeMillis", "()J", "GetGetCurrentTimeMillisHandler:Com.Onesignal.IOSTimeInvoker, OneSignal.Android.Binding")]
			get; 
		}
		...
		long ElapsedRealtime {
			...
			[Register ("getElapsedRealtime", "()J", "GetGetElapsedRealtimeHandler:Com.Onesignal.IOSTimeInvoker, OneSignal.Android.Binding")]
			get; 
		}
	...
	internal partial class IOSTimeInvoker : global::Java.Lang.Object, IOSTime {
		...
		static Delegate cb_getCurrentThreadTimeMillis;
#pragma warning disable 0169
		static Delegate GetGetCurrentThreadTimeMillisHandler ()
		{
			if (cb_getCurrentThreadTimeMillis == null)
				cb_getCurrentThreadTimeMillis = JNINativeWrapper.CreateDelegate ((_JniMarshal_PP_J) n_GetCurrentThreadTimeMillis);
			return cb_getCurrentThreadTimeMillis;
		}

		static long n_GetCurrentThreadTimeMillis (IntPtr jnienv, IntPtr native__this)
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Onesignal.IOSTime> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CurrentThreadTimeMillis;
		}
#pragma warning restore 0169

		IntPtr id_getCurrentThreadTimeMillis;
		public unsafe long CurrentThreadTimeMillis {
			get {
				if (id_getCurrentThreadTimeMillis == IntPtr.Zero)
					id_getCurrentThreadTimeMillis = JNIEnv.GetMethodID (class_ref, "getCurrentThreadTimeMillis", "()J");
				return JNIEnv.CallLongMethod (((global::Java.Lang.Object) this).Handle, id_getCurrentThreadTimeMillis);
			}
		}
